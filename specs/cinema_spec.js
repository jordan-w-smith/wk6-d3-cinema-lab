...
describe('Cinema', function () {
  ...
  it('should be able to find a film by title', function(){
    const actual = cinema.searchFilmByTitle("Dunkirk")
    assert.strictEqual(actual, dunkirk)
  });


  it('should be able to filter films by genre', function() {
    const actual = cinema.searchFilmByGenre("drama")
  ...
  it('should be able to check whether there are no films from a particular year', function() {
    const actual = cinema.checkFilmsByYear(2020)
    assert.strictEqual(actual, false)
  });
  it('should be able to check whether all films are over a particular length', function () {
    const actual = cinema.checkLengthGreaterThan(90)
    assert.strictEqual(actual, true)
  });
  it('should be able to calculate total running time of all films', function () {
    const actual = cinema.totalRunningTimeOfFilms()
  ...
  it('should be able to search by property name & value', function () {
